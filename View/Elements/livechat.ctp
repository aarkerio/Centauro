...
if ( $this->Session->check('Auth.User') ):
    ...
    echo $this->Form->input('Livechat.sender_name', array('size'=>12,'maxlength'=>29))."<span style='font-size:8pt'>&lt;-Nombre</span><br />";  # user_id
endif;
...
foreach ($blogger['Livechat'] as $val):
    ...
    echo '<span style="font-size:7pt;color:green">'.$this->Time->timeAgoInWords($val['created']) .'</span><br /><br />';
endforeach;
